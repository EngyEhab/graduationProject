...
if (isset($_GET['id'])) {
    ...
    ON doctors_account.DoctorCode=p74_assignments_data.doctorCodeInput WHERE assignment_id = '$id'";
    ...
    $myquery = "SELECT * FROM p74_assignments_data 
                INNER JOIN  users  
                ON p74_assignments_data.added_by=users.user_id
...
if (isset($_POST['deleteBtn'])) {
    $id = $_GET['id'];
    $Details = mysqli_query($bis, " DELETE FROM p74_assignments_data WHERE doctorCodeInput='$id'");
}
?>
<!DOCTYPE html>
<html lang="ar">
...
<body class="body">
    ...
    <!-- start delete Modal -->
    <div class="modal fade" id="deleteAssignmentModal" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <p class="fs-3 mainTitle fw-bold">هل بالفعل تريد حذف الإنتداب الخاص بالعضو:</p>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="assignmentData p-2">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <h4 class="mainText fw-bold">الإنتــــــــــــــــــــــــداب :</h4>
                        </div>
                        <div class="col-md-9">
                            <p class="fs-4"><?php echo $assignment_Description; ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
    ...
    <div class="container mt-3 mb-5">
        <div class="row justify-content-end">
            <div class="col-md-2">
                <a href="updateAssignmentData.php?id=<?php echo $assignment_id; ?>">
                    <button id="updateBtn" class="btn btn-warning w-100 rounded-pill fw-bold fs-4 border-2 shadow">تعديــل</button>
                </a>
            </div>
            <div class="col-md-2">
                <button id="deleteBtn" data-bs-toggle="modal" data-bs-target="#deleteAssignmentModal" name="deleteBtn" class="btn btn-danger w-100 rounded-pill fw-bold fs-4 border-2 shadow">حـــذف</button>
            </div>
        </div>
    </div>
