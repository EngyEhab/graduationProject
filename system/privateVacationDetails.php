...
<body class="body">
    ...
    <!-- start delete Modal -->
    <div class="modal fade" id="deletePrivateVacationModal" data-bs-backdrop="static" data-bs-keyboard="false">
    ...
    <div class="container bg-white p-5 shadow mt-5">
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="PrivateVacationData p-2">
                    <div class="row">
                        <div class="col-md-3">
    ...
    <div class="container mt-3 mb-5">
        <div class="row justify-content-end">
            ...
            <div class="col-md-2">
                <button id="deleteBtn" data-bs-toggle="modal" data-bs-target="#deletePrivateVacationModal" name="deleteBtn" class="btn btn-danger w-100 rounded-pill fw-bold fs-4 border-2 shadow">حـــذف</button>
            </div>
        </div>
    </div>
