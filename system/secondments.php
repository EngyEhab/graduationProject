...
<body class="body">
    ...
    <div class="container my-5">
        ...
        ?>
        <?php
        $myquery="SELECT * FROM p74_secondment_data INNER JOIN  p74_doctors_account   ON DoctorCode=doctorCodeInput AND doctorNameInput like '%$st%'  ";
        ...
        ?>
            ...
            <?php } } else{
        $myquery="SELECT * FROM p74_secondment_data INNER JOIN  p74_doctors_account   ON DoctorCode=doctorCodeInput";
        $results=mysqli_query($bis,$myquery);
        while ($row=mysqli_fetch_array($results)){
        ?>
            <div class="col-md-3 d-flex justify-content-center">
