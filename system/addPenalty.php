        ...
        <div class="w-75 mx-auto m-5">
            <div class="container dataContainer p-3">
                ...
                <div class="row my-2 align-items-center">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="penaltyReason" id="penaltyReason">
                    </div>
                </div>
                <div class="row my-2 align-items-center">
                    <div class="col-md-2 text-center">
                ...
                <div class="row my-2">
                    ...
                    <div class="col-md-10">
                        <textarea name="penaltyNotes" id="penaltyNotes" rows="5" class="form-control fs-4"></textarea>
                    </div>
                </div>
                <div class="row my-2 justify-content-end">
                    <div class="col-md-2">
                        <button type="submit" class="addPenaltyBtn rounded-pill border-0 w-100 my-3"  id="submit" name="submit">إضافة</button>
                    </div> 
                </div>
            </div>
        </div>
