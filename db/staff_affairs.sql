...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2023 at 10:36 PM
...
INSERT INTO `p74_application_data` (`app_id`, `app_name`, `Uni_name`, `Faculty_name`, `Program_name`, `Faculty_Uni_logo`, `Program_logo`, `Faculty_Dean`, `Post_grad_vice_dean`, `st_affairs_vice_dean`, `Program_coordinator`) VALUES
...
(24, 'محمد عبد السلام', 'pola', '12345678912345', '456444', 'pola@123.COM', 'pola@12.COM', '888888', '1.jpg', 7, 1, 1, 8, '8888-08-08', '8888-08-08', '88888'),
...
(2, 'بولا شريف', 'pola', '123', 1, '2023-05-19 17:30:57', 1, 'no', 'yes', '2.JPG'),
...
INSERT INTO `p74_users_types` (`user_type_id`, `user_type_name`, `user_type_ar_name`) VALUES
(1, 'Admin', 'مسئول نظام'),
(2, 'Employee', 'موظف');
